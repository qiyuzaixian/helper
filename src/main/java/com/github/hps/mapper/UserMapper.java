...
public interface UserMapper {
    ...
    @Select("SELECT T1.PHONE1 as id,T2.USERID,T2.EMPLOYEEID,T2.USERNAME as nickname,SR.ROLENAME AS roleName,T2.PSWD as password, '' as salt,T1.ORGID, " +
            ...
            "inner join sys_usercoordorgs t4 on t4.userid = t2.userId   INNER JOIN SYS_ROLE SR ON SR.ROLEID = T4.ROLEID "+
            "inner join sys_org t5 on t5.orgid = t4.orgId  " +
